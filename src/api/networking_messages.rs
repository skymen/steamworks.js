...
pub mod networking_messages {
    ...
    #[napi]
    pub fn send_message_to_user(steam_id64: BigInt, data: Buffer) -> Result<(), Error> {
        ...
        fn err(steam_err: SteamError) -> Result<(), Error> {
            ...
            Result::Err(Error::new(napi::Status::GenericFailure, str))
        }
